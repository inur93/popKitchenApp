...
public class ActivityInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        System.out.println("inflate activity info");
        ...
        if(o instanceof CleaningGroupActivity){
            childFragment = new ActivityInfoCleaningFragment();
            this.image.setImageResource(R.drawable.vacuum);
        }
        if(o instanceof DinnerGroupActivity){
            childFragment = new ActivityInfoDinnerFragment();
            this.image.setImageResource(R.drawable.dinner);
        }
        if(o instanceof ExpenseGroupActivity){
            childFragment = new ActivityInfoExpenseFragment();
            this.image.setImageResource(R.drawable.money_bag_with_dollar_symbol);
        }
    ...
    public void onStart() {
        super.onStart();
        getActivity().setTitle(getString(R.string.activity_info_title));
    }
